...
for idx in range(756 + 756, 756 + 756 + 756):
    ...
    command1 = "python cpu_util.py " + " " + hidden_layer_sizes + " " + activation + " " + solver + " " + alpha + " " + learning_rate + " " + warm_start + " > " + home_path + "/mlp_profiler_result/" + str(idx + 1) + "_cpu.txt"
    command2 = "python mem_util.py " + " " + hidden_layer_sizes + " " + activation + " " + solver + " " + alpha + " " + learning_rate + " " + warm_start + " > " + home_path + "/mlp_profiler_result/" + str(idx + 1) + "_mem.txt"
